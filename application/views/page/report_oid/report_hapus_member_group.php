        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <h5 style="text-align:Left; text-decoration: underline;">REPORT HAPUS MEMBER GROUP</h5>
                        </div>
                    ...
                    <div class="row" style="margin-top: 10px;">
                        <div class="col-md-1">
                            <input type="button" class="btn btn-primary" id="btn-cari-report-hapus-member-group" value="Cari">
                        </div>
                    </div>

                    <table id="table-list-hapus-member-group" class="table" width="100%" >
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Tgl Pengajuan</th>
