      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-12">
              <div class="col-md-6">
                <h5 style="text-align:Left; text-decoration: underline;">UPDATE STATUS PERNIKAHAN</h5>
              </div>
          ...
          <div class="float-left">
            ...
            <input type="button" class="btn btn-primary btn-sm" id="btn-view-document" value="Approve">
            <input type="button" class="btn btn-primary btn-sm" id="btn-ok-pernikahan" value="Reject">
          </div>
...
<?php $this->load->view('layout/footer_end'); ?>< ?php $this->load->view('layout/header'); ?>
  <?php $this->load->view('layout/navmenu'); ?>
